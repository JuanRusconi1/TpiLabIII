...
function crearFormulario(registrar){
    ...
    inputEmail = d.querySelector("#loginEmail")
    inputPassword = d.querySelector("#loginPassword")
    inputRepetirPass = d.querySelector("#reLoginPassword")
    ...
    formulario = d.querySelector(".formLogin")
} 
